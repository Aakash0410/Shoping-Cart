...
<br>
	...
	<img src="img/LOGO2.jpg"  align="middle" />	</div>
		...
		<div class="row">
			<div class="col-md-5">
				...
				<form id="login-form" action="Login" method="get" >
						...
						<div class="form-group">
							<input class="form-control" type="password" name="password" id="user_password" placeholder="Password" required="required" />
						</div><!-- /.form-group -->
...
<script type='text/javascript' src=jquery.ui.effect-fade.min.js?ver=1.10.4'></script>
